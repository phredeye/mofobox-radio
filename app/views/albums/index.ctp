<div class="albums index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('small_image');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Html->image($album['Album']['small_image']); ?>&nbsp;</td>
		<td><?php echo $album['Album']['genre']; ?>&nbsp;</td>
		<td><?php echo $album['Album']['year']; ?>&nbsp;</td>
		<td class="actions">
